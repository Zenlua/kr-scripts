 ...
 * Faster overScroll back, by modifying the method int SplineOverScroller.
 * private void startSpringback(int start, int end, int velocity)
 * 
 * fix the line q = Scroller.viscousFluid(q);
 * 
...
public class OverScroller {
	...
	//See SplineOverScroller.startSpringback(int start, int end, int velocity)
	//mDuration 
	public static float MODIFIED_SPLINE_DURATION_RATE = 0.375f;
    private int mMode;
